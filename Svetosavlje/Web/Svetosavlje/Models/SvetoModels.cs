...
namespace Svetosavlje.Models
{
    ...
    public class Main
    {
        ...
        public DnevnoCitanje DailyReading;
        public string DailyFasting;

        public Main(IList<WPBlogModel> v, IList<WPBlogModel> m, IList<WPBlogModel> u, IList<MessageThread> l, IList<PitanjeInfo> p, IList<string> s, string q, DnevnoCitanje r, string f)
        {
            Vijesti = v;
            Misija = m;
            Urednistvo = u;
